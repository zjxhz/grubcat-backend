...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Dish', fields ['name', 'restaurant']
        db.create_unique(u'fanju_dish', ['name', 'restaurant_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Dish', fields ['name', 'restaurant']
        db.delete_unique(u'fanju_dish', ['name', 'restaurant_id'])
