...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fanju_usersource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['fanju.User'], unique=True)),
            ('source', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'fanju', ['UserSource'])


    def backwards(self, orm):
        # Deleting model 'UserSource'
        db.delete_table(u'fanju_usersource')
    ...
    models = {
        ...
        u'fanju.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 0, 0)'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'fanju.usersource': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['fanju.User']", 'unique': 'True'})
        },
        u'fanju.usertag': {
