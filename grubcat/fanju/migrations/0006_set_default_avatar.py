...
from fanju.models import set_default_avatar


class Migration(DataMigration):

    def forwards(self, orm):
        for user in orm.User.objects.filter(avatar=''):
            print 'set default avatar for user %s' % user.id
            set_default_avatar(None, user, False)
