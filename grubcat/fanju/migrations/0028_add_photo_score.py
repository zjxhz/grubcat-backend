...
from fanju.models import UserPhoto, Score


class Migration(DataMigration):

    def forwards(self, orm):
        for photo in UserPhoto.objects.all():
            user = photo.user #User.objects.get(pk=order.customer_id)
            user.add_score(Score.UPLOAD_PHOTO)
    ...
    models = {
        ...
        u'fanju.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
