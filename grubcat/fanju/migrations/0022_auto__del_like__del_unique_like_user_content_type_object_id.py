...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'fanju_like', ['user_id', 'content_type_id', 'object_id'])

        # Deleting model 'Like'
        db.delete_table(u'fanju_like')

        # Adding M2M table for field likes on 'Meal'
        db.create_table(u'fanju_meal_likes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meal', models.ForeignKey(orm[u'fanju.meal'], null=False)),
            ('user', models.ForeignKey(orm[u'fanju.user'], null=False))
        ))
        db.create_unique(u'fanju_meal_likes', ['meal_id', 'user_id'])

        # Adding M2M table for field likes on 'UserPhoto'
        db.create_table(u'fanju_userphoto_likes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userphoto', models.ForeignKey(orm[u'fanju.userphoto'], null=False)),
            ('user', models.ForeignKey(orm[u'fanju.user'], null=False))
        ))
        db.create_unique(u'fanju_userphoto_likes', ['userphoto_id', 'user_id'])


    def backwards(self, orm):
        # Adding model 'Like'
        db.create_table(u'fanju_like', (
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='likes', to=orm['fanju.User'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'fanju', ['Like'])

        # Adding unique constraint on 'Like', fields ['user', 'content_type', 'object_id']
        db.create_unique(u'fanju_like', ['user_id', 'content_type_id', 'object_id'])

        # Removing M2M table for field likes on 'Meal'
        db.delete_table('fanju_meal_likes')

        # Removing M2M table for field likes on 'UserPhoto'
        db.delete_table('fanju_userphoto_likes')
    ...
    models = {
        ...
        u'fanju.meal': {
            ...
            'likes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'liked_meals'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['fanju.User']"}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 9, 0, 0)'}),
        ...
        u'fanju.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 9, 0, 0)'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'fanju.photorequest': {
            'Meta': {'unique_together': "(('from_person', 'to_person'),)", 'object_name': 'PhotoRequest'},
            'from_person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photo_requesting'", 'to': u"orm['fanju.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'to_person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photo_requesters'", 'to': u"orm['fanju.User']"})
        },
        u'fanju.region': {
        ...
        u'fanju.userphoto': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'likes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'liked_photos'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['fanju.User']"}),
