...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meal.cropping'
        db.add_column(u'fanju_meal', 'cropping',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'Meal.photo'
        db.alter_column(u'fanju_meal', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Meal.cropping'
        db.delete_column(u'fanju_meal', 'cropping')


        # Changing field 'Meal.photo'
        db.alter_column(u'fanju_meal', 'photo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'fanju.meal': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 6, 0, 0)'}),
        ...
        u'fanju.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 6, 0, 0)'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
