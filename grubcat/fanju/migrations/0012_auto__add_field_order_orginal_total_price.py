...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.orginal_total_price'
        db.add_column(u'fanju_order', 'orginal_total_price',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=6, decimal_places=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.orginal_total_price'
        db.delete_column(u'fanju_order', 'orginal_total_price')
    ...
    models = {
        ...
        u'fanju.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 9, 0, 0)'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
