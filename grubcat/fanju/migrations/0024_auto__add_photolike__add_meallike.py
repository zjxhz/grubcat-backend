...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhotoLike'
        db.create_table(u'fanju_photolike', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fanju.User'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fanju.UserPhoto'])),
        ))
        db.send_create_signal(u'fanju', ['PhotoLike'])

        # Adding model 'MealLike'
        db.create_table(u'fanju_meallike', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fanju.User'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fanju.Meal'])),
        ))
        db.send_create_signal(u'fanju', ['MealLike'])


    def backwards(self, orm):
        # Deleting model 'PhotoLike'
        db.delete_table(u'fanju_photolike')

        # Deleting model 'MealLike'
        db.delete_table(u'fanju_meallike')
    ...
    models = {
        ...
        u'fanju.meal': {
            ...
            'likes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'meals_i_like'", 'to': u"orm['fanju.User']", 'through': u"orm['fanju.MealLike']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 26, 0, 0)'}),
        ...
        u'fanju.meallike': {
            'Meta': {'object_name': 'MealLike'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fanju.Meal']"}),
        ...
        u'fanju.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 26, 0, 0)'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'fanju.photolike': {
            'Meta': {'object_name': 'PhotoLike'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fanju.UserPhoto']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fanju.User']"})
        },
        ...
        u'fanju.userphoto': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'likes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'photos_i_like'", 'to': u"orm['fanju.User']", 'through': u"orm['fanju.PhotoLike']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
