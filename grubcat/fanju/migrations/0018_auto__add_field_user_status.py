...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fanju_user', 'status',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'fanju_user', 'status')
    ...
    models = {
        ...
        u'fanju.meal': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 19, 0, 0)'}),
        ...
        u'fanju.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 0, 0)'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
