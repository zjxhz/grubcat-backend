...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fanju_photorequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photo_requesting', to=orm['fanju.User'])),
            ('to_person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photo_requesters', to=orm['fanju.User'])),
        ))
        db.send_create_signal(u'fanju', ['PhotoRequest'])

        # Adding unique constraint on 'PhotoRequest', fields ['from_person', 'to_person']
        db.create_unique(u'fanju_photorequest', ['from_person_id', 'to_person_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PhotoRequest', fields ['from_person', 'to_person']
        db.delete_unique(u'fanju_photorequest', ['from_person_id', 'to_person_id'])

        # Deleting model 'PhotoRequest'
        db.delete_table(u'fanju_photorequest')
