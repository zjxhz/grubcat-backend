...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fanju_usercomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fanju.User'], blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fanju.UserComment'], null=True, blank=True)),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['fanju.User'])),
        ))
        db.send_create_signal(u'fanju', ['UserComment'])

        # Adding model 'PhotoComment'
        db.create_table(u'fanju_photocomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fanju.User'], blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fanju.PhotoComment'], null=True, blank=True)),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['fanju.UserPhoto'])),
        ))
        db.send_create_signal(u'fanju', ['PhotoComment'])

        # Deleting field 'MealComment.from_person'
        db.delete_column(u'fanju_mealcomment', 'from_person_id')

        # Deleting field 'MealComment.meal'
        db.delete_column(u'fanju_mealcomment', 'meal_id')

        # Adding field 'MealComment.user'
        db.add_column(u'fanju_mealcomment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['fanju.User'], blank=True),
                      keep_default=False)

        # Adding field 'MealComment.parent'
        db.add_column(u'fanju_mealcomment', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fanju.MealComment'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MealComment.target'
        db.add_column(u'fanju_mealcomment', 'target',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='comments', to=orm['fanju.Meal']),
                      keep_default=False)


        # Changing field 'MealComment.comment'
        db.alter_column(u'fanju_mealcomment', 'comment', self.gf('django.db.models.fields.CharField')(max_length=600))

    def backwards(self, orm):
        # Deleting model 'UserComment'
        db.delete_table(u'fanju_usercomment')

        # Deleting model 'PhotoComment'
        db.delete_table(u'fanju_photocomment')

        # Adding field 'MealComment.from_person'
        db.add_column(u'fanju_mealcomment', 'from_person',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['fanju.User'], blank=True),
                      keep_default=False)

        # Adding field 'MealComment.meal'
        db.add_column(u'fanju_mealcomment', 'meal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='comments', to=orm['fanju.Meal']),
                      keep_default=False)

        # Deleting field 'MealComment.user'
        db.delete_column(u'fanju_mealcomment', 'user_id')

        # Deleting field 'MealComment.parent'
        db.delete_column(u'fanju_mealcomment', 'parent_id')

        # Deleting field 'MealComment.target'
        db.delete_column(u'fanju_mealcomment', 'target_id')


        # Changing field 'MealComment.comment'
        db.alter_column(u'fanju_mealcomment', 'comment', self.gf('django.db.models.fields.CharField')(max_length=300))
    ...
    models = {
        ...
        u'fanju.meal': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
        ...
        u'fanju.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
