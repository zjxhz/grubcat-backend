...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.background_image'
        db.add_column(u'fanju_user', 'background_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.background_image'
        db.delete_column(u'fanju_user', 'background_image')
    ...
    models = {
        ...
        u'fanju.meal': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 24, 0, 0)'}),
        ...
        u'fanju.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 24, 0, 0)'}),
