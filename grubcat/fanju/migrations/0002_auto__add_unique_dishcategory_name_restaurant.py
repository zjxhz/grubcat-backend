...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DishCategory', fields ['name', 'restaurant']
        db.create_unique(u'fanju_dishcategory', ['name', 'restaurant_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DishCategory', fields ['name', 'restaurant']
        db.delete_unique(u'fanju_dishcategory', ['name', 'restaurant_id'])
