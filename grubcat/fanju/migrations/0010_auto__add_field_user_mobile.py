...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fanju_user', 'mobile',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'fanju_user', 'mobile')
    ...
    models = {
        ...
        u'fanju.meal': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 3, 0, 0)'}),
        ...
        u'fanju.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 3, 0, 0)'}),
