...
from fanju.models import Restaurant
from fanju.models import Dish
...
def getRestaurantList(url):
    ...
    for storeInfo in storeInfoList:
        ...
        telImgPath = "fanju/img/tel/" + str(uuid.uuid1()) + ".jpg";
...
def deleteOldData():
    for fname in os.listdir('fanju/img/tel/'):
        print 'removing ' + fname
        os.remove('fanju/img/tel/' + fname)
