...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DishCategory', fields ['name']
        db.delete_unique(u'dish_category', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'DishCategory', fields ['name']
        db.create_unique(u'dish_category', ['name'])
