...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MealComment.timestamp'
        db.alter_column(u'meal_comment', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'GroupComment.parent'
        db.alter_column('eo_groupcomment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eo.GroupComment'], null=True))

        # Changing field 'GroupComment.timestamp'
        db.alter_column('eo_groupcomment', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'MealComment.timestamp'
        db.alter_column(u'meal_comment', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'GroupComment.parent'
        db.alter_column('eo_groupcomment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['eo.GroupComment']))

        # Changing field 'GroupComment.timestamp'
        db.alter_column('eo_groupcomment', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'eo.groupcomment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.GroupComment']", 'null': 'True', 'blank': 'True'}),
        ...
        'eo.meal': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 7, 0, 0)'}),
        ...
        'eo.mealinvitation': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 7, 0, 0)'}),
