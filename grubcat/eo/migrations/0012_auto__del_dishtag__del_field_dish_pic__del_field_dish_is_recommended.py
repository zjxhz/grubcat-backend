...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Dish.pic'
        db.delete_column(u'dish', 'pic')

        # Deleting field 'Dish.is_recommended'
        db.delete_column(u'dish', 'is_recommended')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Dish.pic'
        db.add_column(u'dish', 'pic',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=765, blank=True),
                      keep_default=False)

        # Adding field 'Dish.is_recommended'
        db.add_column(u'dish', 'is_recommended',
    ...
    models = {
        ...
        'eo.dish': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'dishes'", 'null': 'True', 'to': "orm['eo.Menu']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '135'}),
