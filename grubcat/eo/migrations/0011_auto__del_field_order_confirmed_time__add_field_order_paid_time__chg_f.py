...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.confirmed_time'
        db.delete_column(u'order', 'confirmed_time')

        # Adding field 'Order.paid_time'
        db.add_column(u'order', 'paid_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Order.total_price'
        db.alter_column(u'order', 'total_price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Meal.list_price'
        db.alter_column(u'meal', 'list_price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Meal.max_persons'
        db.alter_column(u'meal', 'max_persons', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Meal.actual_persons'
        db.alter_column(u'meal', 'actual_persons', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Adding field 'Order.confirmed_time'
        db.add_column(u'order', 'confirmed_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'Order.paid_time'
        db.delete_column(u'order', 'paid_time')


        # Changing field 'Order.total_price'
        db.alter_column(u'order', 'total_price', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Meal.list_price'
        db.alter_column(u'meal', 'list_price', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Meal.max_persons'
        db.alter_column(u'meal', 'max_persons', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Meal.actual_persons'
        db.alter_column(u'meal', 'actual_persons', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'eo.dish': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['eo.DishTag']", 'null': 'True', 'blank': 'True'}),
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 24, 0, 0)'})
        },
        'eo.mealdishes': {
