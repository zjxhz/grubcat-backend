...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'order', 'table')

        # Deleting field 'Order.restaurant'
        db.delete_column(u'order', 'restaurant_id')


    def backwards(self, orm):
        # Adding field 'Order.table'
        db.add_column(u'order', 'table',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=20),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Order.restaurant'
        raise RuntimeError("Cannot reverse this migration. 'Order.restaurant' and its values cannot be restored.")
