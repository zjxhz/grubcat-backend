...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('eo_group', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['eo.GroupCategory']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('eo_group', 'category_id')
    ...
    models = {
        ...
        'eo.group': {
            'Meta': {'object_name': 'Group'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.GroupCategory']"}),
