...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dish.desc'
        db.add_column(u'dish', 'desc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=765, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dish.desc'
        db.delete_column(u'dish', 'desc')
    ...
    models = {
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 5, 0, 0)'})
        },
        'eo.mealdishes': {
