...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dish.unit'
        db.add_column(u'dish', 'unit',
                      self.gf('django.db.models.fields.CharField')(default=u'\u4efd', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dish.unit'
        db.delete_column(u'dish', 'unit')
