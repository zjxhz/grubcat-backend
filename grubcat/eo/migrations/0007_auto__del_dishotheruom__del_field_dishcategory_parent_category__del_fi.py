...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DishCategory.parent_category'
        db.delete_column(u'dish_category', 'parent_category_id')

        # Deleting field 'Dish.is_mandatory'
        db.delete_column(u'dish', 'is_mandatory')

        # Deleting field 'Dish.taste'
        db.delete_column(u'dish', 'taste')

        # Deleting field 'Dish.has_other_uom'
        db.delete_column(u'dish', 'has_other_uom')

        # Deleting field 'Dish.cooking'
        db.delete_column(u'dish', 'cooking')

        # Deleting field 'Dish.ingredient'
        db.delete_column(u'dish', 'ingredient')


        # Changing field 'Dish.available'
        db.alter_column(u'dish', 'available', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Dish.price'
        db.alter_column(u'dish', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Dish.is_recommended'
        db.alter_column(u'dish', 'is_recommended', self.gf('django.db.models.fields.BooleanField')())
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DishCategory.parent_category'
        db.add_column(u'dish_category', 'parent_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eo.DishCategory'], null=True),
                      keep_default=False)

        # Adding field 'Dish.is_mandatory'
        db.add_column(u'dish', 'is_mandatory',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Dish.taste'
        db.add_column(u'dish', 'taste',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=18),
                      keep_default=False)

        # Adding field 'Dish.has_other_uom'
        db.add_column(u'dish', 'has_other_uom',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Dish.cooking'
        db.add_column(u'dish', 'cooking',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=765, blank=True),
                      keep_default=False)

        # Adding field 'Dish.ingredient'
        db.add_column(u'dish', 'ingredient',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=765, blank=True),
                      keep_default=False)


        # Changing field 'Dish.available'
        db.alter_column(u'dish', 'available', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Dish.price'
        db.alter_column(u'dish', 'price', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Dish.is_recommended'
        db.alter_column(u'dish', 'is_recommended', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'eo.dish': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['eo.DishTag']", 'null': 'True', 'symmetrical': 'False'}),
        ...
        'eo.meal': {
            ...
            'likes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'liked_meals'", 'symmetrical': 'False', 'to': "orm['eo.UserProfile']"}),
            ...
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'meals'", 'symmetrical': 'False', 'to': "orm['eo.UserProfile']"}),
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 23, 0, 0)'})
        },
        'eo.mealdishes': {
