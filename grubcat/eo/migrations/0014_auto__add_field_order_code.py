...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.code'
        db.add_column(u'order', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=12, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.code'
        db.delete_column(u'order', 'code')
    ...
    models = {
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 0, 0)'})
        },
        'eo.mealdishes': {
