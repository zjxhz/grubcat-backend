    ...
    models = {
        ...
        'eo.dish': {
            ...
            'menu': ('django.db.models.fields.related.ForeignKey', [],
                         {'related_name': "'dishes'", 'null': 'True', 'to': "orm['eo.Menu']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '135'}),
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [],
                         {'to': "orm['eo.DishTag']", 'null': 'True', 'symmetrical': 'False'}),
            'unit': ('django.db.models.fields.CharField', [], {'default': "u'\\u4efd'", 'max_length': '30'}),
            'uom': ('django.db.models.fields.CharField', [], {'default': "u'\\u4efd'", 'max_length': '30'})
        },
        'eo.dishcategory': {
            ...
            'menu': (
                'django.db.models.fields.related.ForeignKey', [],
                    {'related_name': "'categories'", 'to': "orm['eo.Menu']"}),
        ...
        'eo.meal': {
            ...
            'dishes': ('django.db.models.fields.related.ManyToManyField', [],
                           {'to': "orm['eo.Dish']", 'through': "orm['eo.MealDishes']", 'symmetrical': 'False'}),
            'host': ('django.db.models.fields.related.ForeignKey', [],
                         {'related_name': "'host_user'", 'null': 'True', 'to': "orm['eo.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'introduction': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            'likes': ('django.db.models.fields.related.ManyToManyField', [],
                          {'related_name': "'liked_meals'", 'symmetrical': 'False', 'to': "orm['eo.UserProfile']"}),
            ...
            'participants': ('django.db.models.fields.related.ManyToManyField', [],
                                 {'related_name': "'meals'", 'symmetrical': 'False', 'to': "orm['eo.UserProfile']"}),
        ...
        'eo.mealcomment': {
            ...
            'timestamp': (
                'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 23, 0, 0)'})
        },
        'eo.mealdishes': {
        ...
        'eo.menu': {
            ...
            'restaurant': (
                'django.db.models.fields.related.OneToOneField', [], {'to': "orm['eo.Restaurant']", 'unique': 'True'})
        },
        'eo.order': {
        ...
        'eo.userprofile': {
            ...
            'favorite_restaurants': ('django.db.models.fields.related.ManyToManyField', [],
                                         {'related_name': "'user_favorite'", 'symmetrical': 'False',
            ...
            'recommended_following': ('django.db.models.fields.related.ManyToManyField', [],
                                          {'to': "orm['eo.UserProfile']", 'db_table': "'recommended_following'",
                                           'symmetrical': 'False'}),
