...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DishCategory.menu'
        db.delete_column(u'dish_category', 'menu_id')

        # Deleting field 'Dish.menu'
        db.delete_column(u'dish', 'menu_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DishCategory.menu'
        db.add_column(u'dish_category', 'menu',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='categories', to=orm['eo.Menu']),
                      keep_default=False)

        # Adding field 'Dish.menu'
        db.add_column(u'dish', 'menu',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dishes', null=True, to=orm['eo.Menu'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'eo.dish': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['eo.DishCategory']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '135'}),
