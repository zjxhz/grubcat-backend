...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.meal'
        db.add_column(u'order', 'meal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='orders', to=orm['eo.Meal']),
                      keep_default=False)

        # Deleting field 'Meal.order'
        db.delete_column(u'meal', 'order_id')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.meal'
        db.delete_column(u'order', 'meal_id')

        # Adding field 'Meal.order'
        db.add_column(u'meal', 'order',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['eo.Order'], unique=True, null=True),
                      keep_default=False)
