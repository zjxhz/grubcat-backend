...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'user_profile', 'business')

        # Adding field 'UserProfile.industry'
        db.add_column(u'user_profile', 'industry',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'user_profile', 'business',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.industry'
        db.delete_column(u'user_profile', 'industry')
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 15, 0, 0)'}),
        ...
        'eo.mealinvitation': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 15, 0, 0)'}),
