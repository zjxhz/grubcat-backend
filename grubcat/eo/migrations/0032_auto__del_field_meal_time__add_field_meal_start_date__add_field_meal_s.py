...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Meal.time'
        db.delete_column(u'meal', 'time')

        # Adding field 'Meal.start_date'
        db.add_column(u'meal', 'start_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 11, 0, 0)),
                      keep_default=False)

        # Adding field 'Meal.start_time'
        db.add_column(u'meal', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.time(19, 0)),
                      keep_default=False)


        # Changing field 'Meal.max_persons'
        db.alter_column(u'meal', 'max_persons', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Meal.restaurant'
        db.alter_column(u'meal', 'restaurant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eo.Restaurant'], null=True))

    def backwards(self, orm):
        # Adding field 'Meal.time'
        db.add_column(u'meal', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 11, 0, 0)),
                      keep_default=False)

        # Deleting field 'Meal.start_date'
        db.delete_column(u'meal', 'start_date')

        # Deleting field 'Meal.start_time'
        db.delete_column(u'meal', 'start_time')


        # Changing field 'Meal.max_persons'
        db.alter_column(u'meal', 'max_persons', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Meal.restaurant'
        db.alter_column(u'meal', 'restaurant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['eo.Restaurant']))
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'list_price': ('django.db.models.fields.DecimalField', [], {'default': '30', 'max_digits': '6', 'decimal_places': '2'}),
            ...
            'region': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['eo.Region']"}),
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 11, 0, 0)'}),
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 11, 0, 0)'})
        },
        'eo.mealinvitation': {
        ...
        'eo.menu': {
            ...
            'average_price': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '1'}),
        ...
        'eo.menuitem': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['eo.Menu']"}),
            'num': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
        ...
        'eo.userprofile': {
            ...
            'motto': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True'}),
            ...
            'weibo_access_token': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            'weibo_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
