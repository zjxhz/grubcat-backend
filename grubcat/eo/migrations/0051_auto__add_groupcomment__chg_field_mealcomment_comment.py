...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('eo_groupcomment', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eo.GroupComment'])),
        ))
        db.send_create_signal('eo', ['GroupComment'])


        # Changing field 'MealComment.comment'
        db.alter_column(u'meal_comment', 'comment', self.gf('django.db.models.fields.CharField')(max_length=300))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MealComment.comment'
        db.alter_column(u'meal_comment', 'comment', self.gf('django.db.models.fields.CharField')(max_length=42))
    ...
    models = {
        ...
        'eo.groupcomment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.GroupComment']"}),
