...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'visitor', ['from_person_id', 'to_person_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Visitor', fields ['from_person', 'to_person']
        db.delete_unique(u'visitor', ['from_person_id', 'to_person_id'])

        # Deleting model 'Visitor'
        db.delete_table(u'visitor')
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 12, 0, 0)'}),
        ...
        'eo.mealinvitation': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 0, 0)'}),
        ...
        'eo.menu': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 0, 0)'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        'eo.visitor': {
            'Meta': {'unique_together': "(('from_person', 'to_person'),)", 'object_name': 'Visitor', 'db_table': "u'visitor'"},
