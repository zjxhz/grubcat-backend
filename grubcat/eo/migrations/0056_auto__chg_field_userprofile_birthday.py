...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'user_profile', 'birthday', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.birthday'
        db.alter_column(u'user_profile', 'birthday', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 26, 0, 0)'}),
