...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DishCategory.restaurant'
        db.add_column(u'dish_category', 'restaurant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eo.Restaurant'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DishCategory.restaurant'
        db.delete_column(u'dish_category', 'restaurant_id')
    ...
    models = {
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 18, 0, 0)'})
        },
        'eo.mealdishes': {
