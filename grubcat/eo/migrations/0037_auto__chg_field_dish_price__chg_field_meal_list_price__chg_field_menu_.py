...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dish', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=1))

        # Changing field 'Meal.list_price'
        db.alter_column(u'meal', 'list_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=1))

        # Changing field 'Menu.average_price'
        db.alter_column(u'menu', 'average_price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=1))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Meal.list_price'
        db.alter_column(u'meal', 'list_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

        # Changing field 'Menu.average_price'
        db.alter_column(u'menu', 'average_price', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=1))
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 13, 0, 0)'}),
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 13, 0, 0)'})
        },
        'eo.mealinvitation': {
