...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meal.region'
        db.alter_column(u'meal', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eo.Region'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Meal.region'
        db.alter_column(u'meal', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eo.Region']))
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'list_price': ('django.db.models.fields.DecimalField', [], {'default': '30', 'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 12, 0, 0)'}),
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 12, 0, 0)'})
        },
        'eo.mealinvitation': {
