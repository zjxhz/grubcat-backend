...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.category'
        db.alter_column('eo_group', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eo.GroupCategory'], null=True))

    def backwards(self, orm):

        # Changing field 'Group.category'
        db.alter_column('eo_group', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['eo.GroupCategory']))
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 29, 0, 0)'}),
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 29, 0, 0)'})
        },
        'eo.mealinvitation': {
