...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meal.region'
        db.add_column(u'meal', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['eo.Region']),
                      keep_default=False)

        # Adding field 'Meal.extra_requests'
        db.add_column(u'meal', 'extra_requests',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meal.region'
        db.delete_column(u'meal', 'region_id')

        # Deleting field 'Meal.extra_requests'
        db.delete_column(u'meal', 'extra_requests')
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Menu']", 'null': 'True'}),
            ...
            'region': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Region']"}),
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']"}),
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 25, 0, 0)'})
        },
        'eo.mealinvitation': {
