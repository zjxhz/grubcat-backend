...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.weibo_access_token'
        db.add_column(u'user_profile', 'weibo_access_token',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.weibo_access_token'
        db.delete_column(u'user_profile', 'weibo_access_token')
    ...
    models = {
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 12, 0, 0)'})
        },
        'eo.mealdishes': {
