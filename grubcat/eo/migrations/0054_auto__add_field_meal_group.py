...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meal.group'
        db.add_column(u'meal', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eo.Group'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meal.group'
        db.delete_column(u'meal', 'group_id')
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 15, 0, 0)'}),
        ...
        'eo.mealinvitation': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 15, 0, 0)'}),
