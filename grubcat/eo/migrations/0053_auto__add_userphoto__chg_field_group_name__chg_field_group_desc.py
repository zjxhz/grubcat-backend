...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('eo_group', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=15))

        # Changing field 'Group.desc'
        db.alter_column('eo_group', 'desc', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Group.name'
        db.alter_column('eo_group', 'name', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))

        # Changing field 'Group.desc'
        db.alter_column('eo_group', 'desc', self.gf('django.db.models.fields.CharField')(max_length=300))
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 14, 0, 0)'}),
        ...
        'eo.mealinvitation': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 14, 0, 0)'}),
