...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupCategory.cover'
        db.add_column('eo_groupcategory', 'cover',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupCategory.cover'
        db.delete_column('eo_groupcategory', 'cover')
    ...
    models = {
        ...
        'eo.meal': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eo.Restaurant']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 3, 0, 0)'}),
        ...
        'eo.mealcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 3, 0, 0)'})
        },
        'eo.mealinvitation': {
