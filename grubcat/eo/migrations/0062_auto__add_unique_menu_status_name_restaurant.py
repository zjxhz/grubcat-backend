...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Menu', fields ['status', 'name', 'restaurant']
        db.create_unique(u'menu', ['status', 'name', 'restaurant_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Menu', fields ['status', 'name', 'restaurant']
        db.delete_unique(u'menu', ['status', 'name', 'restaurant_id'])
