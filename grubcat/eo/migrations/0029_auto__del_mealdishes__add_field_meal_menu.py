...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'MealDishes'
        db.delete_table(u'meal_dishes')

        # Adding field 'Meal.menu'
        db.add_column(u'meal', 'menu',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eo.Menu'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'MealDishes'
        db.create_table(u'meal_dishes', (
        ...
        db.send_create_signal('eo', ['MealDishes'])

        # Deleting field 'Meal.menu'
        db.delete_column(u'meal', 'menu_id')
